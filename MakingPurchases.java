...
public class MakingPurchases extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/download1.jpg"))); // NOI18N

        jLabel2.setText("Lemon Macaroons($1.99)");

        jLabel3.setText("Blueberry Macaroons($1.79)");

        jLabel4.setText("Raspberry Macaroons($1.99)");

        jLabel5.setText("Lime Macaroons($1.79)");

        jlabel1.setText("Tax(13%):");

        jlabel2.setText("subtotal:");

        jlabel3.setText("grand total:");

        jLabel6.setText("Banana Macaroons($2.29)");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(34, 34, 34)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jtxt2, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jtxt3, javax.swing.GroupLayout.DEFAULT_SIZE, 75, Short.MAX_VALUE)
                                    .addComponent(jtxt4))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jButton1))
                            .addComponent(jtxt1, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jtxt5, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //for subtatol and drand total
        num1 = Double.parseDouble(jtxt1.getText());
        num2 = Double.parseDouble(jtxt2.getText());
        num3 = Double.parseDouble(jtxt3.getText());
        num4 = Double.parseDouble(jtxt4.getText());
        num5 = Double.parseDouble(jtxt5.getText());

        answer1 = 1.99 * num1 + 1.79 * num2 + 1.99 * num3 + 1.79 * num4 + 2.29 * num5;//subtotal needed...
        answer2 = answer1 * 0.13;//tax is...
        answer3 = answer1 + answer2;//how much is the total...
        //display the answer in the answer label on the form
        jlbl1.setText(String.valueOf(answer2));
        jlbl2.setText(String.valueOf(answer1));
        jlbl3.setText(String.valueOf(answer3));
